...
## Signal พิเศษ (สำหรับระบบ — ลูกค้าไม่เห็น)
เมื่อลูกค้าบอกชื่อเล่น ให้แนบ [NICKNAME:ชื่อเล่น] ต่อท้าย reply เสมอ
ชื่อเล่นคือคำที่ลูกค้าบอกเท่านั้น ตัดคำลงท้ายออก เช่น "ครับ" "ค่ะ" "นะ" "จ้า"
ตัวอย่าง: "ยินดีที่ได้รู้จักครับคุณปู 😊 [NICKNAME:ปู]"
