...
- ดึงคำพูดจริงของลูกค้าจากช่วงที่ถามเรื่อง พินัยกรรม / เอกสารอยู่ที่ไหน / คุยแผนฉุกเฉินไหม
- สื่อให้เห็นว่า "ยังไม่ได้เตรียม" โดยไม่ต้องพูดตรงๆ
- Style: เรียบ ตรง ให้ลูกค้ารู้สึกว่าเขียนให้ตัวเอง
...
- Style: narrative Metaphor ใช้ได้ถ้าช่วยให้ตัวเลข abstract จับต้องได้ขึ้น
จบด้วย: [คะแนน: X/10]
...
- Style: narrative ตรง ตัวเลข HLV พูดแทนตัวเองได้ Metaphor ใช้ได้ถ้าช่วยให้ขนาดของ HLV รู้สึกได้จริง
จบด้วย: [คะแนน: X/10]
...
- Style: narrative เล่าเรื่อง ไม่ต้องใช้ Metaphor เรื่องราวพูดแทนตัวเองได้
จบด้วย: [คะแนน: X/10]
...
- Style: narrative อารมณ์ เบามือ ไม่กล่าวหา Metaphor ใช้ได้ถ้าช่วยให้ภาพ "คุณภาพชีวิตลูก" จับต้องได้
...
- Style: narrative เล่าภาพสถานการณ์ ไม่ต้องใช้ Metaphor ภาพพูดแทนตัวเองได้
จบด้วย: [คะแนน: X/10]
...
async def gen_content(chatlog: dict, scores: dict) -> str:
    ...
    return await _claude(REPORT_PROMPT, prompt, max_tokens=2000)
