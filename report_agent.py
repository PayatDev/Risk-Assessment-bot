...
## สไตล์รวม
- เพื่อนที่เป็นผู้เชี่ยวชาญ ไม่สั่งสอน ไม่แนะนำ 
- เน้นฉายภาพให้ลูกค้าเห็นถึงสถานะการณ์ ห้ามขู่ หรือ ทำให้ดูมืดมน เด็ดขาด
- เขียนจากข้อเท็จ อย่าดราม่าเยอะ
...
- ค่าใช้จ่ายที่รอไม่ได้ทันทีหลังเกิดเหตุ ค่ารักษาพยาบาลครั้งสุดท้าย ค่าทำศพ ด่าดำเนินการต่างๆ
- ค่าใช้จ่ายปรับตัวอย่างน้อย 1 ปี ค่ากินใช้โดยรักษาคุณภาพชีวิตเดิมได้
- หนี้สินที่ยังเดินต่อแม้เจ้าของจะไม่อยู่แล้ว
- หนี้ พูดถึงแต่หนี้ที่ไม่มีการคุ้มครอง หนี้บ้านส่วนใหญ่มีการคุ้มครอง 
- นอกจากรายได้ หลีกเลี่ยงพูดถึงตัวเลขอื่นในการฉายภาพให้เห็น
- ห้ามนำรายจ่ายมาคิดเนื่องจากเราไม่รู้ข้อเท็จจริงทั้งหมด
...
- ห้าม quote คำพูดลูกค้าในหมวด — ใช้ narrative ล้วน
- HLV = รายได้ที่เราสามารถหาได้ยันเกษียญ ครอบครัวจะสูญเสียไป ไม่ใช่แค่ปีนี้
...
- คนมีสิทธิตามกฎหมายอาจจะอ้างสิทธิ
...
- เงินที่เตรียมไว้อาจจะถูกใช้ไม่ตรงจุดประสงค์
...
- ห้าม quote คำพูดลูกค้าในหมวด — ใช้ narrative ล้วน
- ฉายภาพวันที่เกิดเหตุ ว่ามีคู่มือปฎิบัติย่อมดีกว่าไม่มี
- คนข้างหลังต้องรู้ทำอะไรท่ามกลางความเจ็บปวด ไม่ใช่มืดบอด หรือเดาหาทางเอาเอง
- รู้ว่าเอกสารอยู่ที่ไหน เข้าถึงได้ทันทีไหม
- รู้ว่าต้องโทรหาใคร แจ้งอะไรก่อน
...
## กฎเหล็ก
- ห้ามแนะนำวิธีแก้ปัญหาทุกกรณีในทุกท่อน ห้ามแนะนำ เช่น ควรจะ น่าจะ แนะนำให้
- ความยาวรวม 500-600 คำ (ไม่นับ tag)
- plain text ล้วน ไม่มี markdown ไม่มี header ไม่มี tag ใดๆ
- ตอบเฉพาะเนื้อหา ไม่มีคำอธิบาย
- ต้องเขียนครบทุกหมวดจนจบ ห้ามหยุดกลางหมวด
- เรียกลูกค้าว่า "คุณ[ชื่อ]" เสมอ ห้ามเรียกชื่อเปล่า
- ในแต่ละหมวด ฉายภาพตามจริงก่อน แล้วค่อยให้น้ำหนักหนักที่จุดเดียวที่ impact สุด 
- ห้ามทุกประโยคเป็น worst-case สำคัญมาก ไม่อยากให้ลูกค้าหนักเกินไป"""
...
def build_docx(nickname: str, date_th: str, content: str, scores: dict, gaps: list) -> str:
    ...
    label("ขั้นตอนถัดไป")
    para(
        "รายงานนี้เป็นภาพรวมเบื้องต้น หากต้องการแผนเฉพาะสำหรับครอบครัวของคุณ "
        "ผมให้บริการวางแผนที่ครอบคลุมทุกด้าน",
